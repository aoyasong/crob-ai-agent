...
function Nh(e) {
  return (
    e instanceof So || (e = vo(e)), e ? ((e = e.rgb()), new Ht(e.r, e.g, e.b, e.opacity)) : new Ht()
  )
}
function Cs(e, t, n, r) {
...
ra(
  ...
  Ou(So, {
    brighter(e) {
      return (
        (e = e == null ? ci : Math.pow(ci, e)), new tn(this.h, this.s, this.l * e, this.opacity)
      )
    },
    darker(e) {
      return (
        (e = e == null ? go : Math.pow(go, e)), new tn(this.h, this.s, this.l * e, this.opacity)
      )
    },
    rgb() {
        ...
        Ee(
          (xe) => {
            st(Fe, 'z-index', _()),
              ...
              ce(Le, 'data-id', g()),
              ce(Le, 'aria-label', F() === null ? void 0 : F() ? F() : `Edge from ${x()} to ${C()}`)
          },
...
function Dt() {
  ...
  return {
    ...
    fitBounds: async (b, N) => {
      ...
      return (
        await E.setViewport(M, { duration: N == null ? void 0 : N.duration }), Promise.resolve(!0)
      )
    },
